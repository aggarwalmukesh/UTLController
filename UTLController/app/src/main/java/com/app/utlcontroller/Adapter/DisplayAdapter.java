...
public class DisplayAdapter extends BaseAdapter {
    ...
    public DisplayAdapter(Context context, ArrayList<ModelData> listData) {
        this.context = context;
        this.listData = listData;
    }
    public DisplayAdapter(Context context, ArrayList<ModelData> listData, PositionCallback callback) {
        this.context = context;
        this.listData = listData;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        MyViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.layout_readingdisplay, null);
